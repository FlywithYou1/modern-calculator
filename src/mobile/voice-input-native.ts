...
// PermissionState is only available at runtime; importing the type from @tauri-apps/api/core
// keeps us aligned with command responses from the Rust plugin.
...
export async function createNativeVoiceInput(
